---
description: Explains how MCP servers and skills work in Claude Code, how the harness surfaces each to the model, how the model invokes them, and how to combine an MCP with a skill. Use when someone asks what MCP or skills are, how they differ, when to build one versus the other, or how the two fit together.
---
